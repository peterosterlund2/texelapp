...
TX_SRC	:= bitBoard.cpp book.cpp cluster.cpp clustertt.cpp computerPlayer.cpp \
	   enginecontrol.cpp endGameEval.cpp evaluate.cpp \
	   ...
	   moveGen.cpp numa.cpp parameters.cpp parallel.cpp piece.cpp position.cpp \
	   search.cpp tbprobe.cpp texel.cpp textio.cpp polyglot.cpp transpositionTable.cpp \
	   tbgen.cpp treeLogger.cpp tuigame.cpp uciprotocol.cpp util/logger.cpp \
	   util/random.cpp util/timeUtil.cpp util/util.cpp syzygy/rtb-probe.cpp
...
ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
  MY_ARCH_DEF += -DHAS_POPCNT
endif

include $(CLEAR_VARS)
LOCAL_MODULE    := texel
LOCAL_SRC_FILES := $(TX_SRC) $(TX_SRC_GTB)
LOCAL_CFLAGS    := -O3 -fPIE $(TX_INC) -DHAS_CTZ -DHAS_PREFETCH -DHAS_RT $(MY_ARCH_DEF) -s
